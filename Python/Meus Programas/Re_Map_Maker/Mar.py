...
jogador = pygame.image.load('sprites/personagem.png').convert_alpha()
jogador_scale = pygame.transform.scale(jogador, (23, 32))
jogador_pos = jogador_scale.get_rect()
jogador_pos.x = 200
jogador_pos.y = 200

faca = pygame.image.load('sprites/faca.png')
...
craby = pygame.image.load('sprites/carangueijo.png')
craby_pos = craby.get_rect()
inimigos_dict = {'nome': 'carangueijo', 'image': craby, 'pos': craby_pos}
inimigos = []

grama = pygame.image.load('sprites/grama.png').convert()
grama_d = pygame.image.load('sprites/grama_d.png').convert()
grama_e = pygame.image.load('sprites/grama_e.png').convert()
terra = pygame.image.load('sprites/terra.png').convert()
